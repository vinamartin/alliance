...
.[[_isr_attributes_table]]ISR: Attributes in this group relate to Intelligence, Surveillance and Reconnaissance
...
|isr.sensor-type
|Identiifies which type of sensor produced the data.
|String
...
|isr.cloud-cover
|Identifies the percentage of the image that is obscured by cloud.
|Integer
|0-100
|
...
|isr.platform-name
|The name of the plafrom associated with the resource.
|String
|
|
