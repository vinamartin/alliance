 ...
 */
package com.connexta.alliance.nsili.mockserver.server;
...
public class MockWebService {
    ...
    private static final String PRODUCT_RELATIVE_PATH = "/src/main/java/com/connexta/alliance/nsili/mockserver/data/product.jpg";
