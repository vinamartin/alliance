...
public class ClassifyingCountryKlvProcessorTest {
  ...
  public void test() {
    ...
    ArgumentCaptor<Attribute> argumentCaptor =
        KlvUtilities.testKlvProcessor(
            new ClassifyingCountryKlvProcessor(),
            Stanag4609TransportStreamParser.CLASSIFYING_COUNTRY,
            Arrays.asList(id1, id2, id1, id2));

    assertThat(argumentCaptor.getValue().getName(), is(AttributeNameConstants.CLASSIFYING_COUNTRY));
