...
/**
 * Handle the various KLV data elements/structures that returned by the STANAG 4609 parser. The main
 * entry point is {@link #handle(Map, KlvHandler, Map)}.
 */
