...
/**
 * Trim all of the {@link Trimmable} handlers. This is in case one of the values
 * was not supplied by the KLV data. For example the lat value was supplied, but the lon value
 * was {@link KlvDataElement#isErrorIndicated()}.
 */
