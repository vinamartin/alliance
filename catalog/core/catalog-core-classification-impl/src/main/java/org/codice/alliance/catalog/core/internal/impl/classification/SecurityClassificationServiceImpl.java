...
/**
 * Returns a comparator that sorts classification strings based on a user defined sort order {@link
 * #setSortOrder(List)}. If a comparator encounters a classification string that was not in the user
 * defined sort order, then that string will be given the highest possible sort priority.
 *
...
public class SecurityClassificationServiceImpl implements SecurityClassificationService {
  ...
  private static class SecurityClassificationComparator implements Comparator<String> {
    ...
    private SecurityClassificationComparator(Map<String, Integer> securityClassificationSortOrder) {
