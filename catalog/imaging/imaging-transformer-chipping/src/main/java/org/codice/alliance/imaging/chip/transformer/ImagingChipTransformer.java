 ...
 * purpose is to add the @Body and @Header annotations and serve as the defining interface for a
 * MetacardTransformer Camel proxy.
 */
public interface ImagingChipTransformer extends MetacardTransformer {
  /** {@inheritDoc} */
  BinaryContent transform(
      @Body Metacard metacard, @Header("args") Map<String, Serializable> arguments)
