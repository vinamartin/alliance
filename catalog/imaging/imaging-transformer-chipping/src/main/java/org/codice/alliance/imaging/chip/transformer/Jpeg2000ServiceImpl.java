...
class Jpeg2000ServiceImpl extends AbstractJpegService {
    ...
    private byte[] encodeToByteArray(BufferedImage bufferedImage, J2KImageWriter writer,
            J2KImageWriteParam writeParams) throws IOException {
     ...
     * <p>
     * wxyz = JPEG 2000 lossy, where "wxyz" is
     * the target or expected bitrate (in bitsPerPixelPerBand) for
     * the final layer of each tile. Note: When there
     * is no decimal point, the decimal point is
     * implicit and assumed to be in the middle (i.e.
     * wx.yz).
     */
    @Override
