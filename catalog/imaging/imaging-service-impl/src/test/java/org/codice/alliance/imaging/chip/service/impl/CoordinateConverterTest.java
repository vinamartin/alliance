...
public class CoordinateConverterTest {
    ...
    public void testToLonLat() {
        ...
        assertThat(newLatLong.get(0)
                .get(0), Matchers.closeTo(-30 + xOneThird, 0.01));
        assertThat(newLatLong.get(0)
                .get(1), Matchers.closeTo(-30 + yTwoThirds, 0.01));

        assertThat(newLatLong.get(1)
                .get(0), Matchers.closeTo(-30 + xTwoThirds, 0.01));
        assertThat(newLatLong.get(1)
                .get(1), Matchers.closeTo(-30 + yTwoThirds, 0.01));

        assertThat(newLatLong.get(2)
                .get(0), Matchers.closeTo(-30 + xTwoThirds, 0.01));
        assertThat(newLatLong.get(2)
                .get(1), Matchers.closeTo(-30 + yOneThird, 0.01));

        assertThat(newLatLong.get(3)
                .get(0), Matchers.closeTo(-30 + xOneThird, 0.01));
        assertThat(newLatLong.get(3)
                .get(1), Matchers.closeTo(-30 + yOneThird, 0.01));
