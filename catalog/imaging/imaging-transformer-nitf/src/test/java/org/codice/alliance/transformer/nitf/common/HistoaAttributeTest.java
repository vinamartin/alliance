...
public class HistoaAttributeTest {
  ...
  public void testSystypeSet() throws NitfFormatException {
    ...
    Serializable actual = HistoaAttribute.SYSTYPE_ATTRIBUTE.getAccessorFunction().apply(tre);
  ...
  public void testPcSet() throws NitfFormatException {
    ...
    Serializable actual = HistoaAttribute.PC_ATTRIBUTE.getAccessorFunction().apply(tre);
  ...
  public void testPcNotSet() throws NitfFormatException {
    when(tre.getIntValue(HistoaAttribute.PRIOR_COMPRESSION_NAME))
  ...
  public void testPeSet() throws NitfFormatException {
    ...
    Serializable actual = HistoaAttribute.PE_ATTRIBUTE.getAccessorFunction().apply(tre);
  ...
  public void testPeNotSet() throws NitfFormatException {
    when(tre.getIntValue(HistoaAttribute.PRIOR_ENHANCEMENTS_NAME))
        .thenThrow(NitfFormatException.class);
    Serializable actual = HistoaAttribute.PE_ATTRIBUTE.getAccessorFunction().apply(tre);
    assertThat(actual, is(nullValue()));
  }
  ...
  public void testRemapFlagSet() throws NitfFormatException {
    ...
    Serializable actual = HistoaAttribute.REMAP_FLAG_ATTRIBUTE.getAccessorFunction().apply(tre);
  ...
  public void testDataMappingIdSet() throws NitfFormatException {
    ...
    Serializable actual = HistoaAttribute.LUTID_ATTRIBUTE.getAccessorFunction().apply(tre);
