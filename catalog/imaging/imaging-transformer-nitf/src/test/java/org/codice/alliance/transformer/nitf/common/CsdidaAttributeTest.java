...
public class CsdidaAttributeTest {
  ...
  public void testPlatformIdBothSet() throws NitfFormatException {
    ...
    Serializable actual = CsdidaAttribute.PLATFORM_ID_ATTRIBUTE.getAccessorFunction().apply(tre);
  ...
  public void testPlatformIdPlatformOnly() throws NitfFormatException {
    when(tre.getFieldValue(CsdidaAttribute.PLATFORM_CODE_SHORT_NAME)).thenReturn(PLATFORM_CODE);
    when(tre.getFieldValue(CsdidaAttribute.VEHICLE_ID_SHORT_NAME))
  ...
  public void testPlatformIdVehicleOnly() throws NitfFormatException {
    when(tre.getFieldValue(CsdidaAttribute.PLATFORM_CODE_SHORT_NAME))
        .thenThrow(NitfFormatException.class);
    when(tre.getFieldValue(CsdidaAttribute.VEHICLE_ID_SHORT_NAME)).thenReturn(VEHICLE_ID);
  ...
  public void testDayOfDatasetCollectionMin() throws NitfFormatException {
    ...
    Serializable actual = CsdidaAttribute.DAY_ATTRIBUTE.getAccessorFunction().apply(tre);
  ...
  public void testMonOfDatasetCollectionSet() throws NitfFormatException {
    ...
    Serializable actual = CsdidaAttribute.MONTH_ATTRIBUTE.getAccessorFunction().apply(tre);
  ...
  public void testYearOfDatasetCollectionMin() throws NitfFormatException {
    ...
    Serializable actual = CsdidaAttribute.YEAR_ATTRIBUTE.getAccessorFunction().apply(tre);
  ...
  public void testPassNumMin() throws NitfFormatException {
    ...
    Serializable actual = CsdidaAttribute.PASS_ATTRIBUTE.getAccessorFunction().apply(tre);
    assertThat(actual, is(1));
  }
  ...
  public void testOperationNumMin() throws NitfFormatException {
    ...
    Serializable actual = CsdidaAttribute.OPERATION_ATTRIBUTE.getAccessorFunction().apply(tre);
    assertThat(actual, is(0));
  }
  ...
  public void testOperationNumNotSet() throws NitfFormatException {
    when(tre.getIntValue(CsdidaAttribute.OPERATION_SHORT_NAME))
        .thenThrow(NitfFormatException.class);
    Serializable actual = CsdidaAttribute.OPERATION_ATTRIBUTE.getAccessorFunction().apply(tre);
    assertThat(actual, is(nullValue()));
  }
  ...
  public void testSensorIdSet() throws NitfFormatException {
    ...
    Serializable actual = CsdidaAttribute.SENSOR_ID_ATTRIBUTE.getAccessorFunction().apply(tre);
  ...
  public void testSensorIdNotSet() throws NitfFormatException {
    when(tre.getIntValue(CsdidaAttribute.SENSOR_ID_SHORT_NAME))
        .thenThrow(NitfFormatException.class);
    Serializable actual = CsdidaAttribute.SENSOR_ID_ATTRIBUTE.getAccessorFunction().apply(tre);
    assertThat(actual, is(nullValue()));
  }
  ...
  public void testProductIdSet() throws NitfFormatException {
    ...
    Serializable actual = CsdidaAttribute.PRODUCT_ID_ATTRIBUTE.getAccessorFunction().apply(tre);
  ...
  public void testProductIdNotSet() throws NitfFormatException {
    when(tre.getIntValue(CsdidaAttribute.PRODUCT_ID_SHORT_NAME))
        .thenThrow(NitfFormatException.class);
    Serializable actual = CsdidaAttribute.PRODUCT_ID_ATTRIBUTE.getAccessorFunction().apply(tre);
    assertThat(actual, is(nullValue()));
  }
  ...
  public void testTimeSet() throws NitfFormatException {
    ...
    Serializable actual = CsdidaAttribute.TIME_ATTRIBUTE.getAccessorFunction().apply(tre);
  ...
  public void testProcessTimeSet() throws NitfFormatException {
    ...
    Serializable actual = CsdidaAttribute.PROCESS_TIME_ATTRIBUTE.getAccessorFunction().apply(tre);
    Date convDate = (Date) actual;
    DateFormat dateFormat = new SimpleDateFormat(TreUtility.TRE_DATE_FORMAT);
    dateFormat.setTimeZone(TimeZone.getTimeZone("GMT"));
  ...
  public void testProcessTimeNotSet() throws NitfFormatException {
    when(tre.getIntValue(CsdidaAttribute.PROCESS_TIME_SHORT_NAME))
        .thenThrow(NitfFormatException.class);
    Serializable actual = CsdidaAttribute.PROCESS_TIME_ATTRIBUTE.getAccessorFunction().apply(tre);
    assertThat(actual, is(nullValue()));
  }
  ...
  public void testSoftwareVersionNumberSet() throws NitfFormatException {
    when(tre.getFieldValue(CsdidaAttribute.SOFTWARE_VERSION_NUMBER_SHORT_NAME))
        .thenReturn("v1.1.0");
    Serializable actual =
        CsdidaAttribute.SOFTWARE_VERSION_NUMBER_ATTRIBUTE.getAccessorFunction().apply(tre);
  ...
  public void testSoftwareVersionNotSet() throws NitfFormatException {
    when(tre.getIntValue(CsdidaAttribute.SOFTWARE_VERSION_NUMBER_SHORT_NAME))
        .thenThrow(NitfFormatException.class);
    Serializable actual =
        CsdidaAttribute.SOFTWARE_VERSION_NUMBER_ATTRIBUTE.getAccessorFunction().apply(tre);
    assertThat(actual, is(nullValue()));
