...
public class PiaprdAttributeTest {
    ...
    public void testAccessId() throws NitfFormatException {
        when(tre.getFieldValue(PiaprdAttribute.ACCESS_ID_ATTRIBUTE.getShortName())).thenReturn(
                "THIS IS AN IPA FILE.                                       -END-");

        String accessId = (String) PiaprdAttribute.ACCESS_ID_ATTRIBUTE.getAccessorFunction()
                .apply(tre);

        assertThat(accessId,
                is("THIS IS AN IPA FILE.                                       -END-"));
    }
    ...
    public void testFmControlNumber() throws NitfFormatException {
        ...
        String fmControlNumber =
                (String) PiaprdAttribute.FM_CONTROL_NUMBER_ATTRIBUTE.getAccessorFunction()
                        .apply(tre);
    ...
    public void testSubjectiveDetail() throws NitfFormatException {
        ...
        String subjectiveDetail =
                (String) PiaprdAttribute.SUBJECTIVE_DETAIL_ATTRIBUTE.getAccessorFunction()
                        .apply(tre);
    ...
    public void testProductCode() throws NitfFormatException {
        when(tre.getFieldValue(PiaprdAttribute.PRODUCT_CODE_ATTRIBUTE.getShortName())).thenReturn(
                "YY");

        String productCode = (String) PiaprdAttribute.PRODUCT_CODE_ATTRIBUTE.getAccessorFunction()
                .apply(tre);
    ...
    public void testProducerSupplement() throws NitfFormatException {
        ...
        String producerSupplement =
                (String) PiaprdAttribute.PRODUCER_SUPPLEMENT_ATTRIBUTE.getAccessorFunction()
                        .apply(tre);
    ...
    public void testProductIdNumber() throws NitfFormatException {
        ...
        String productIdNumber =
                (String) PiaprdAttribute.PRODUCT_ID_NUMBER_ATTRIBUTE.getAccessorFunction()
                        .apply(tre);
    ...
    public void testProductShortName() throws NitfFormatException {
        ...
        String productShortName =
                (String) PiaprdAttribute.PRODUCT_SHORT_NAME_ATTRIBUTE.getAccessorFunction()
                        .apply(tre);
    ...
    public void testProducerCode() throws NitfFormatException {
        when(tre.getFieldValue(PiaprdAttribute.PRODUCER_CODE_ATTRIBUTE.getShortName())).thenReturn(
                "27");

        String producerCode = (String) PiaprdAttribute.PRODUCER_CODE_ATTRIBUTE.getAccessorFunction()
                .apply(tre);
    ...
    public void testProducerCreateTime() throws NitfFormatException {
        ...
        String producerCreateTime =
                (String) PiaprdAttribute.PRODUCER_CREATE_TIME_ATTRIBUTE.getAccessorFunction()
                        .apply(tre);
    ...
    public void testMapId() throws NitfFormatException {
        when(tre.getFieldValue(PiaprdAttribute.MAP_ID_ATTRIBUTE.getShortName())).thenReturn(
                "132                                -END-");

        String mapId = (String) PiaprdAttribute.MAP_ID_ATTRIBUTE.getAccessorFunction()
                .apply(tre);
    ...
    public void testKeywordRepetitions() throws NitfFormatException {
        ...
        Integer keywordRepetitions =
                (Integer) PiaprdAttribute.KEYWORD_REPETITIONS_ATTRIBUTE.getAccessorFunction()
                        .apply(tre);
    ...
    public void testKeyword() throws NitfFormatException {
        ...
        String keyword = (String) PiaprdAttribute.KEYWORD_ATTRIBUTE.getAccessorFunction()
                .apply(tre);
