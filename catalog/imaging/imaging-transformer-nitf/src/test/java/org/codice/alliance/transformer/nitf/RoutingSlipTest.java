...
public class RoutingSlipTest {
  ...
  private static final String NO_IMAGE_NO_TRE_NTF_FILENAME = "src/test/resources/noImageNoTre.ntf";
  ...
  public void testChannelImageNoTres() throws FileNotFoundException, NitfFormatException {
    NitfSegmentsFlow parserInputFlow =
        new NitfParserInputFlowImpl().file(new File(IMAGE_NO_TRE_NTF_FILENAME)).headerOnly();
  ...
  public void testChannelImageTre() throws FileNotFoundException, NitfFormatException {
    NitfSegmentsFlow parserInputFlow =
        new NitfParserInputFlowImpl().file(new File(IMAGE_TRE_NTF_FILENAME)).headerOnly();
  ...
  public void testChannelNoImageTre() throws FileNotFoundException, NitfFormatException {
    NitfSegmentsFlow parserInputFlow =
        new NitfParserInputFlowImpl().file(new File(NO_IMAGE_TRE_NTF_FILENAME)).headerOnly();
  ...
  public void testChannelNoImageNoTre() throws FileNotFoundException, NitfFormatException {
    NitfSegmentsFlow parserInputFlow =
        new NitfParserInputFlowImpl().file(new File(NO_IMAGE_NO_TRE_NTF_FILENAME)).headerOnly();
