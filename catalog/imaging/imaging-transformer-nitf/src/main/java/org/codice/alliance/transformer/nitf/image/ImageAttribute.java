...
public class ImageAttribute extends NitfAttributeImpl<ImageSegment> {
    ...
    public static final String IMAGE_RELEASING_INSTRUCTIONS =
            PREFIX + "image-releasing-instructions";
    ...
    public static final ImageAttribute IMAGE_SOURCE_ATTRIBUTE =
            new ImageAttribute(Isr.ORIGINAL_SOURCE,
                    "ISORCE",
    ...
    public static final ImageAttribute NUMBER_OF_SIGNIFICANT_ROWS_IN_IMAGE_ATTRIBUTE =
            new ImageAttribute(Media.HEIGHT,
                    "NROWS",
    ...
    public static final ImageAttribute NUMBER_OF_SIGNIFICANT_COLUMNS_IN_IMAGE_ATTRIBUTE =
            new ImageAttribute(Media.WIDTH,
                    "NCOLS",
    ...
    public static final ImageAttribute IMAGE_REPRESENTATION_ATTRIBUTE =
            new ImageAttribute(Media.ENCODING,
                    "IREP",
    ...
    public static final ImageAttribute IMAGE_CATEGORY_ATTRIBUTE = new ImageAttribute(Isr.CATEGORY,
            "ICAT",
    ...
    public static final ImageAttribute IMAGE_COMPRESSION_ATTRIBUTE =
            new ImageAttribute(Media.COMPRESSION,
                    "IC",
    ...
    public static final ImageAttribute FILE_PART_TYPE_ATTRIBUTE = new ImageAttribute(FILE_PART_TYPE,
            "IM",
            segment -> "IM",
    ...
    public static final ImageAttribute IMAGE_SECURITY_CLASSIFICATION_ATTRIBUTE = new ImageAttribute(
    ...
    public static final ImageAttribute IMAGE_CLASSIFICATION_SECURITY_SYSTEM_ATTRIBUTE =
            new ImageAttribute(IMAGE_CLASSIFICATION_SECURITY_SYSTEM,
                    "ISCLSY",
                    segment -> segment.getSecurityMetadata()
                            .getSecurityClassificationSystem(),
                    BasicTypes.STRING_TYPE);

    public static final ImageAttribute IMAGE_CODEWORDS_ATTRIBUTE = new ImageAttribute(
            IMAGE_CODEWORDS,
            "ISCODE",
            segment -> segment.getSecurityMetadata()
                    .getCodewords(),
    ...
    public static final ImageAttribute IMAGE_CONTROL_AND_HANDLING_ATTRIBUTE = new ImageAttribute(
    ...
    public static final ImageAttribute IMAGE_RELEASING_INSTRUCTIONS_ATTRIBUTE = new ImageAttribute(
    ...
    public static final ImageAttribute IMAGE_DECLASSIFICATION_TYPE_ATTRIBUTE = new ImageAttribute(
    ...
    public static final ImageAttribute IMAGE_DECLASSIFICATION_DATE_ATTRIBUTE = new ImageAttribute(
    ...
    public static final ImageAttribute IMAGE_DECLASSIFICATION_EXEMPTION_ATTRIBUTE =
            new ImageAttribute(IMAGE_DECLASSIFICATION_EXEMPTION,
                    "ISDCXM",
                    segment -> segment.getSecurityMetadata()
                            .getDeclassificationExemption(),
                    BasicTypes.STRING_TYPE);

    public static final ImageAttribute IMAGE_DOWNGRADE_ATTRIBUTE = new ImageAttribute(
            IMAGE_DOWNGRADE,
            "ISDG",
            segment -> segment.getSecurityMetadata()
                    .getDowngrade(),
    ...
    public static final ImageAttribute IMAGE_DOWNGRADE_DATE_ATTRIBUTE = new ImageAttribute(
    ...
    public static final ImageAttribute IMAGE_CLASSIFICATION_TEXT_ATTRIBUTE = new ImageAttribute(
    ...
    public static final ImageAttribute IMAGE_CLASSIFICATION_AUTHORITY_TYPE_ATTRIBUTE =
            new ImageAttribute(IMAGE_CLASSIFICATION_AUTHORITY_TYPE,
                    "ISCATP",
                    segment -> segment.getSecurityMetadata()
    ...
    public static final ImageAttribute IMAGE_CLASSIFICATION_AUTHORITY_ATTRIBUTE =
            new ImageAttribute(IMAGE_CLASSIFICATION_AUTHORITY,
                    "ISCAUT",
                    segment -> segment.getSecurityMetadata()
                            .getClassificationAuthority(),
                    BasicTypes.STRING_TYPE);

    public static final ImageAttribute IMAGE_CLASSIFICATION_REASON_ATTRIBUTE = new ImageAttribute(
    ...
    public static final ImageAttribute IMAGE_SECURITY_SOURCE_DATE_ATTRIBUTE = new ImageAttribute(
    ...
    public static final ImageAttribute IMAGE_SECURITY_CONTROL_NUMBER_ATTRIBUTE = new ImageAttribute(
    ...
    public static final ImageAttribute PIXEL_VALUE_TYPE_ATTRIBUTE = new ImageAttribute(
            PIXEL_VALUE_TYPE,
            "PVTYPE",
    ...
    public static final ImageAttribute ACTUAL_BITS_PER_PIXEL_PER_BAND_ATTRIBUTE =
            new ImageAttribute(ACTUAL_BITS_PER_PIXEL_PER_BAND,
                    "ABPP",
                    ImageSegment::getActualBitsPerPixelPerBand,
                    BasicTypes.INTEGER_TYPE);

    public static final ImageAttribute PIXEL_JUSTIFICATION_ATTRIBUTE = new ImageAttribute(
            PIXEL_JUSTIFICATION,
            "PJUST",
    ...
    public static final ImageAttribute IMAGE_COORDINATE_REPRESENTATION_ATTRIBUTE =
            new ImageAttribute(IMAGE_COORDINATE_REPRESENTATION,
                    "ICORDS",
                    segment -> segment.getImageCoordinatesRepresentation()
                            .name(),
                    BasicTypes.STRING_TYPE);

    public static final ImageAttribute NUMBER_OF_IMAGE_COMMENTS_ATTRIBUTE = new ImageAttribute(
    ...
    public static final ImageAttribute IMAGE_COMMENT_1_ATTRIBUTE = new ImageAttribute(
            IMAGE_COMMENT_1,
            "ICOM1",
            segment -> segment.getImageComments()
                    .size() > 0 ?
    ...
    public static final ImageAttribute IMAGE_COMMENT_2_ATTRIBUTE = new ImageAttribute(
            IMAGE_COMMENT_2,
            "ICOM2",
            segment -> segment.getImageComments()
                    .size() > 1 ?
    ...
    public static final ImageAttribute IMAGE_COMMENT_3_ATTRIBUTE = new ImageAttribute(
            IMAGE_COMMENT_3,
            "ICOM3",
            segment -> segment.getImageComments()
                    .size() > 2 ?
    ...
    public static final ImageAttribute NUMBER_OF_BANDS_ATTRIBUTE = new ImageAttribute(
            NUMBER_OF_BANDS,
            "NBANDS",
            ImageSegment::getNumBands,
            BasicTypes.INTEGER_TYPE);

    public static final ImageAttribute IMAGE_MODE_ATTRIBUTE = new ImageAttribute(IMAGE_MODE,
            "IMODE",
            segment -> segment.getImageMode()
                    .name(),
            BasicTypes.STRING_TYPE);

    public static final ImageAttribute NUMBER_OF_BLOCKS_PER_ROW_ATTRIBUTE = new ImageAttribute(
            NUMBER_OF_BLOCKS_PER_ROW,
            "NBPR",
            ImageSegment::getNumberOfBlocksPerRow,
            BasicTypes.INTEGER_TYPE);

    public static final ImageAttribute NUMBER_OF_BLOCKS_PER_COLUMN_ATTRIBUTE = new ImageAttribute(
    ...
    public static final ImageAttribute NUMBER_OF_PIXELS_PER_BLOCK_HORIZONTAL_ATTRIBUTE =
            new ImageAttribute(NUMBER_OF_PIXELS_PER_BLOCK_HORIZONTAL,
                    "NPPBH",
    ...
    public static final ImageAttribute NUMBER_OF_PIXELS_PER_BLOCK_VERTICAL_ATTRIBUTE =
            new ImageAttribute(NUMBER_OF_PIXELS_PER_BLOCK_VERTICAL,
                    "NPPBV",
                    ImageSegment::getNumberOfPixelsPerBlockVertical,
                    BasicTypes.INTEGER_TYPE);

    public static final ImageAttribute NUMBER_OF_BITS_PER_PIXEL_ATTRIBUTE = new ImageAttribute(
            NUMBER_OF_BITS_PER_PIXEL,
            "NBPP",
            ImageSegment::getNumberOfBitsPerPixelPerBand,
            BasicTypes.INTEGER_TYPE);

    public static final ImageAttribute IMAGE_DISPLAY_LEVEL_ATTRIBUTE = new ImageAttribute(
            IMAGE_DISPLAY_LEVEL,
            "IDLVL",
            ImageSegment::getImageDisplayLevel,
            BasicTypes.INTEGER_TYPE);

    public static final ImageAttribute IMAGE_ATTACHMENT_LEVEL_ATTRIBUTE = new ImageAttribute(
            IMAGE_ATTACHMENT_LEVEL,
            "IALVL",
            ImageSegment::getAttachmentLevel,
            BasicTypes.INTEGER_TYPE);

    public static final ImageAttribute IMAGE_LOCATION_ATTRIBUTE = new ImageAttribute(IMAGE_LOCATION,
            "ILOC",
            segment -> segment.getImageLocationRow() + "," + segment.getImageLocationColumn(),
            BasicTypes.STRING_TYPE);

    public static final ImageAttribute IMAGE_MAGNIFICATION_ATTRIBUTE = new ImageAttribute(
            IMAGE_MAGNIFICATION,
            "IMAG",
    ...
    public static final ImageAttribute TARGET_IDENTIFIER_ATTRIBUTE =
            new ImageAttribute(Isr.TARGET_ID,
                    "TGTID",
