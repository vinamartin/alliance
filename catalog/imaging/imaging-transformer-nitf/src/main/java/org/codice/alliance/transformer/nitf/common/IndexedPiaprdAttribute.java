...
public class IndexedPiaprdAttribute extends NitfAttributeImpl<TreGroup> {
     ...
     */
    public static final IndexedPiaprdAttribute KEYWORD_ATTRIBUTE = new IndexedPiaprdAttribute(
            KEYWORD,
            "KEYWORD",
            tre -> TreUtility.getTreValue(tre, "KEYWORD"),
            BasicTypes.STRING_TYPE);

    private IndexedPiaprdAttribute(String longName, String shortName,
