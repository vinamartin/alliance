...
public class TestResultDAGConverter {
    ...
    public void testChangeAttribute() throws Exception {
        ...
        card.setAttribute(new AttributeImpl(Metacard.MODIFIED, testModifiedDate));
    ...
    private MetacardImpl getTestCard() {
        ...
        card.setAttribute(new AttributeImpl(Metacard.CREATED, TEST_CREATE_DATE));
        card.setCreatedDate(TEST_CREATE_DATE);
        card.setAttribute(new AttributeImpl(Metacard.MODIFIED, TEST_CREATE_DATE));
