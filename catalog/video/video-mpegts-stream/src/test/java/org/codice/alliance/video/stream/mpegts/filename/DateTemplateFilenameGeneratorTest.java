...
public class DateTemplateFilenameGeneratorTest {
  ...
  public void test() {
    ...
    String filename =
        templateFilenameGenerator.generateFilename("mpegts-stream-%{date=" + fmt + "}.ts");
  ...
  public void testMultiplePatterns() {
    ...
    String filename =
        templateFilenameGenerator.generateFilename(
    ...
    String expected = "mpegts-stream-" + sdf1.format(date) + "-xyz-" + sdf2.format(date) + ".ts";
  ...
  public static class TestFileExtensionFilenameGenerator {
    ...
    public void testGenerateFilenameAddingExt() {
      assertThat(fileExtensionFilenameGenerator.generateFilename("a"), Matchers.is("a." + EXT));
    }

    @Test
    public void testGenerateFilenameExtAlreadyPresent() {
      assertThat(
          fileExtensionFilenameGenerator.generateFilename("a." + EXT), Matchers.is("a." + EXT));
    }

    @Test
    public void testGenerateFilenameMissingDot() {
      assertThat(
          fileExtensionFilenameGenerator.generateFilename("a" + EXT),
