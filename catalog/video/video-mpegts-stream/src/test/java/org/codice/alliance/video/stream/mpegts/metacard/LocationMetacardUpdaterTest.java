...
public class LocationMetacardUpdaterTest {
  ...
  public void testDefaultCtor() {
    ...
    assertThat(
        locationMetacardUpdater.getPostUnionGeometryOperator(), is(GeometryOperator.IDENTITY));
    assertThat(
        locationMetacardUpdater.getPreUnionGeometryOperator(), is(GeometryOperator.IDENTITY));
  }
  ...
  public void testGetGeometryFunction() {
    ...
    LocationMetacardUpdater updater =
        new LocationMetacardUpdater(preUnionGeometryOperator, postUnionGeometryOperator);
