...
public class ImageSourceSensorMetacardUpdater extends UnionSingleMetacardUpdater {
    public ImageSourceSensorMetacardUpdater() {
        super(AttributeNameConstants.IMAGE_SOURCE_SENSOR);
    }

    @Override
    public String toString() {
        return "ImageSourceSensorMetacardUpdater{}";
    }
}
