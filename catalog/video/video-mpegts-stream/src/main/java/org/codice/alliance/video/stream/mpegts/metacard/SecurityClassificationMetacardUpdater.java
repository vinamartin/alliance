 ...
 * rating. Uses {@link SecurityClassificationService#getSecurityClassificationComparator()} to get a
 * comparator that will be used to sort the security strings from the lowest to highest security
 * rating.
 */
